...
- Insert -> Load Family -> `Column_demo.rfa`
- Modify -> Explode -> Full Explode
- Manicotti -> Extrude walls (takes almost 5s)
...
Revit 2021 - .NET 4.8 | Revit 2020/2019 - .NET **4.7** | Revit 2018 - .NET 4.6 | Revit 2017/2016/2015 - .NET 4.5 | Revit 2014 - .NET 4.0
...
To craft your add-in from scratch please use the template by Jeremy Tammik. ZIP the template source code ([VisualStudioRevitAddinWizard 2020.0.0.0](https://github.com/jeremytammik/VisualStudioRevitAddinWizard/releases/tag/2020.0.0.0)) under `/cs` 
as `Revit2020AddinWizardCs1.zip`, and place it here:
